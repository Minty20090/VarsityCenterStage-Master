...
public class FlickerTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            double y = gamepad1.left_stick_y/1.1; // Remember, this is reversed!
...
//            robot.intakeL.setPosition(intakePosition);
            ...
            if(gamepad1.right_bumper) {
                showEncoderCounts(robot.fLeftWheel.getCurrentPosition(), robot.fRightWheel.getCurrentPosition(), robot.bLeftWheel.getCurrentPosition(), robot.bRightWheel.getCurrentPosition(), robot.lift.getCurrentPosition());
